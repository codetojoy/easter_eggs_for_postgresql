...
try {
    ...
    expectedLocations << new Location(address:'5150 Longworth Ave', city:'Charlottetown', province:'PE', version: 2);
    ...
    expectedLocations << new Location(address:'9190 Queen St', city:'Victoria', province:'BC', version: 1);
